...
namespace Identity.Provider.Services
{
    public class TokenService : ITokenServices
    {
        ...
        public TokenService(IConfiguration configuration, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<TokenModel> GenerateJwtToken(ApplicationUser user)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(ClaimTypes.Email, user.Email),
                 new Claim("UserID", unitID.ToString())
